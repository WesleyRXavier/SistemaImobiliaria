    ...
    <div class="dash_login">
        <div class="dash_login_left">
            <article class="dash_login_left_box">
                ...
                <form name="login" action="{{route('admin.autenticar')}}" method="post" autocomplete="off">
                    @csrf
                    <label>
                        <span class="field icon-envelope">E-mail:</span>
                        <input type="email" name="email" placeholder="Informe seu e-mail" value="wesleyrob9@hotmail.com"
                            required />
                    </label>
                ...
                <footer>
                    ...
                    <p class="dash_login_left_box_support">
                        <a target="_blank" class="icon-whatsapp transition text-green"
                            href="https://api.whatsapp.com/send?phone=DDI+DDD+TELEFONE&text=Olá, preciso de ajuda com o login.">Precisa
                            de Suporte?</a>
                    </p>
                </footer>
            </article>
