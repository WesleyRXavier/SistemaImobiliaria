                        ...
                        <div class="label_gc">
                            ...
                            <label class="label">
                                <input type="checkbox" name="rent"
                                    {{ (old('rent')=='on' || old('rent')==true ? 'checked': ($property->sale==true ? 'checked' :''))}}><span>Locação</span>
                            </label>
                        </div>
                            ...
                            <label class="label">
                                ...
                                <select name="category" class="select2">
                                    <option value="Imóvel Residencial"
                                        {{ (old('category')=='Imóvel Residencia'  ? 'selected':($property->category=='Imóvel Residencial' ? 'selected' :'')) }}>
                                    ...
                                    <option value="Terreno"
                                        {{ (old('category')=='terrain'  ? 'selected':($property->category=='Terreno' ? 'selected' :'')) }}>
                                        Terreno</option>
                                </select>
                            </label>
