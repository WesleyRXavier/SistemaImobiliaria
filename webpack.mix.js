...
//transforma  arquivos css em 1 so chamado libs, mas tem que colcoar na ordem certta
.styles(['resources/views/admin/assets/js/datatables/css/jquery.dataTables.min.css',
...
.scripts([
   ...
   .scripts([
      ...
      //junta varios js em um memso arquivos , mas tem que ser na ordem certa
      .scripts([
...
.copyDirectory('resources/views/admin/assets/css/fonts', 'public/backend/assets/css/fonts')// fonts

.copyDirectory('resources/views/admin/assets/images', 'public/backend/assets/images')//iimagem
